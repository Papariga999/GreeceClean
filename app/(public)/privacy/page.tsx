  ...
  el: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: 'Κατά την υποβολή αναφοράς συλλέγουμε: φωτογραφίες της παράνομης απόρριψης, γεωγραφικές συντεταγμένες (GPS) της τοποθεσίας, την κατηγορία της παράβασης και, προαιρετικά, μια σύντομη περιγραφή. Δεν απαιτείται εγγραφή χρήστη.',
      },
      {
        h: 'Πώς χρησιμοποιούμε τα δεδομένα',
        p: 'Τα δεδομένα χρησιμοποιούνται αποκλειστικά για: (α) την εμφάνιση των αναφορών στον δημόσιο χάρτη μετά από έλεγχο, (β) την αποστολή ειδοποίησης στον αρμόδιο δήμο και (γ) τη στατιστική ανάλυση για την παρακολούθηση της κατάστασης των δήμων.',
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: 'When submitting a report we collect: photos of the illegal dump, GPS coordinates of the location, the category of the violation, and optionally a short description. No user registration is required.',
      },
      {
        h: 'How we use the data',
        p: 'Data is used solely to: (a) display verified reports on the public map, (b) notify the responsible municipality, and (c) generate statistics for tracking municipal cleanup performance.',
      },
      {
        h: 'Data storage',
  ...
  de: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: 'Bei der Einreichung einer Meldung erheben wir: Fotos der illegalen Deponie, GPS-Koordinaten des Standorts, die Kategorie des Verstoßes und optional eine kurze Beschreibung. Eine Benutzerregistrierung ist nicht erforderlich.',
      },
      {
        h: 'Wie wir die Daten verwenden',
        p: 'Daten werden ausschließlich verwendet für: (a) die Anzeige geprüfter Meldungen auf der öffentlichen Karte, (b) die Benachrichtigung der zuständigen Gemeinde und (c) statistische Auswertungen zur Verfolgung der kommunalen Reinigungsleistung.',
      },
      {
        h: 'Datenspeicherung',
