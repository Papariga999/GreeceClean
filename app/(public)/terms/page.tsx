...
const CONTENT = {
  el: {
    ...
    sections: [
      ...
      { h: 'Περιεχόμενο αναφορών', p: 'Με την υποβολή αναφοράς δηλώνετε ότι οι πληροφορίες είναι αληθείς εξ όσων γνωρίζετε. Δεν επιτρέπεται η ανάρτηση φωτογραφιών που απεικονίζουν πρόσωπα χωρίς συναίνεση ή που παραβιάζουν πνευματικά δικαιώματα.' },
      { h: 'Περιορισμός ευθύνης', p: 'Το GreeceClean δεν εγγυάται τη λήψη μέτρων από τους δήμους. Η πλατφόρμα λειτουργεί ως μεσολαβητής μεταξύ πολιτών και δημοτικών αρχών, χωρίς να φέρει νομική ευθύνη για την έκβαση των αναφορών.' },
