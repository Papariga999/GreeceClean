/* GreeceClean · Screen 5 — Landing (ShockStat hero + before/after + leaderboards) */
  ...
  return (
    <window.PhoneFrame height={1320} contentBg="#fff">
      ...
      <div style={{ flex: 1, overflow: 'hidden' }}>
        {/* hero */}
        <div style={{ background: 'linear-gradient(160deg, #0D6FDB, #0B57AD)', color: '#fff', padding: '34px 22px 38px', textAlign: 'center' }}>
          <h1 style={{ margin: '0 0 12px', fontSize: 34, fontWeight: 800, lineHeight: 1.12, letterSpacing: '-0.02em', color: '#fff' }}>Κράτα την Ελλάδα <span style={{ color: '#BFE0C6' }}>καθαρή</span></h1>
        ...
        <div style={{ background: T.primary, color: '#fff', textAlign: 'center', padding: '26px 16px' }}>
          <p style={{ margin: 0, fontWeight: 600, fontSize: 14 }}>GreeceClean 2026</p>
          <p style={{ margin: '4px 0 0', fontSize: 12, color: '#BBD9F7' }}>Για μια καθαρή Ελλάδα 🌿</p>
        </div>
      </div>
    </window.PhoneFrame>
  );
