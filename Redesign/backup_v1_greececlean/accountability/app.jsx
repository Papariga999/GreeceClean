/* GreeceClean · Accountability redesign — design canvas composition */
...
function ShockSpec() {
  ...
  return <Spec bg="#0B57AD"><div style={{ margin: 'auto' }}><ShockStat value={4812} label="ημέρες αγνοημένων αναφορών" size={46} /></div></Spec>;
}
