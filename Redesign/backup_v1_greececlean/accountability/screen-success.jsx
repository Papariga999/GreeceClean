/* GreeceClean · Screen 4 — Success after reporting (growth moment) */
      ...
      <div style={{ flex: 1, overflow: 'hidden', padding: '8px 18px 18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ background: T.bg, borderRadius: 16, padding: '12px 14px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ flex: 1, fontFamily: 'ui-monospace, monospace', fontSize: 13, color: T.primary, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>greececlean.gr/r/ab12cd34ef56</span>
