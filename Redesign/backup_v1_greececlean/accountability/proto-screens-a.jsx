/* GreeceClean · Clickable prototype — screen bodies (wired to `nav`) */
...
function LandingBody({ nav }) {
  ...
  return (
    <div>
      ...
      <div style={{ background: 'linear-gradient(160deg, #0D6FDB, #0B57AD)', color: '#fff', padding: '34px 22px 36px', textAlign: 'center' }}>
