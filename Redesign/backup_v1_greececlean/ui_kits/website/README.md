# Website UI Kit — GreeceClean Public Site

A high-fidelity, interactive recreation of the GreeceClean public-facing website. Open `index.html` for a clickable walkthrough.
