# Admin UI Kit — GreeceClean Moderation Console

A high-fidelity recreation of the internal GreeceClean admin dashboard. **Greek-only**, as in the real product. Open `index.html`.
