/* Katharos · Accountability layer — shared kit
   PhoneFrame, severity engine, and all NEW interactive components.
   Greek-first. Exports to window. */

const T = {
  primary: '#006994', primary600: '#005A80', primary50: '#E6EFF3',
  action: '#6B7C3A', action600: '#5A6830',
...
function Confetti({ run }) {
  const colors = ['#006994', '#6B7C3A', '#F59E0B', '#DC2626', '#15A34A', '#3387D7'];
