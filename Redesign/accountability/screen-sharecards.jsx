/* Katharos · Screen 8 — ShareCard artefacts (OG share images)
...
function ShareCard({ variant }) {
  ...
  if (variant === 'resolved') {
    return (
      <div style={{ width: W, height: H, background: 'linear-gradient(135deg, #6B7C3A, #495427)', display: 'flex', flexDirection: 'column', padding: '24px 28px', position: 'relative', overflow: 'hidden', fontFamily: "'Inter', sans-serif", color: '#fff' }}>
