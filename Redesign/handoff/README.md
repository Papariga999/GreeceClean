> ⭐ **Latest (2026 · Katharos rebrand):** for the move to the **Katharos** identity, use **[`HANDOVER_katharos_visual_rebrand.md`](./HANDOVER_katharos_visual_rebrand.md)** — a paste-ready, visual-only brief for Codex on Antigravity (logo, pins, colours, fonts; code & copy untouched). The documents below describe the *earlier* GreeceClean refresh and are kept for reference.
