/* Katharos — Partners / Sponsors page · full trilingual copy (EL · EN · DE)
...
const PARTNERS_I18N = {
  ...
  EL: {
    ...
    claims: {
      ...
      heading: 'Γιατί αξίζει να στηρίξετε το Katharos',
    ...
    region: {
      eyebrow: 'Katharos · Τοπικό επίπεδο',
      placeName: 'Νάξος',
  ...
  EN: {
    ...
    claims: {
      ...
      heading: 'Why Katharos is worth supporting',
    ...
    region: {
      eyebrow: 'Katharos · Regional layer',
      placeName: 'Naxos',
  ...
  DE: {
    ...
    claims: {
      ...
      heading: 'Warum Katharos unterstützenswert ist',
    ...
    region: {
      eyebrow: 'Katharos · Regionaler Layer',
      placeName: 'Naxos',
...
const PARTNERS_EMAIL = 'partners@katharos.gr';
