/* GreeceClean · Clickable prototype — report flow + success */
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#fff' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '8px 18px 18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ background: T.bg, borderRadius: 16, padding: '12px 14px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}><span style={{ flex: 1, fontFamily: 'ui-monospace, monospace', fontSize: 13, color: T.primary, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>greececlean.gr/r/ab12cd34ef56</span><span style={{ fontSize: 18 }}>📋</span></div>
        </div>
        <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, paddingTop: 2 }}>
          ...
          <p style={{ textAlign: 'center', fontSize: 12, color: T.ink3, margin: 0 }}>💡 Πρόσθεσε το GreeceClean στην αρχική οθόνη</p>
        </div>
      </div>
