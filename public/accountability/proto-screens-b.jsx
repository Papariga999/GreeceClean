/* GreeceClean · Clickable prototype — detail / flow bodies */
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 14, position: 'relative', background: T.bg }}>
        ...
        <window.Card style={{ padding: 14, background: '#EAF7EC', border: 'none' }}><p style={{ margin: 0, fontSize: 13, color: '#2E7D34', lineHeight: 1.5, textAlign: 'center' }}>Αυτό το πέτυχαν <b>14 άνθρωποι</b> μαζί. Μοιράσου το αποτέλεσμα.</p></window.Card>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 16, display: 'flex', flexDirection: 'column', gap: 14, background: T.bg }}>
        <div style={{ background: 'linear-gradient(140deg, #0D6FDB, #0B57AD)', borderRadius: 20, padding: 18, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <window.Card style={{ padding: 16 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: 7, height: 90 }}>
            {bars.map((b, i) => <div key={i} style={{ flex: 1, height: b + '%', background: i === bars.length - 1 ? T.action : '#BBD9F7', borderRadius: '4px 4px 0 0', opacity: i === bars.length - 1 ? 1 : 0.55 }} />)}
          </div>
  ...
  return (
    <div>
      ...
      <div style={{ padding: '6px 16px 14px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ background: 'linear-gradient(140deg, #39B24A, #2E7D34)', borderRadius: 20, padding: '18px 16px', color: '#fff', display: 'flex', justifyContent: 'space-around', textAlign: 'center' }}>
